 ...
 *
 * Responsibilities: Make petitions to the browser with the right headers and arguments.
 *
 * @author Ubidots
 */
...
public class ServerBridge {
    ...
    /**
     * Created to maintain compatibility with previous version
    ...
    String get(String path, Map<String, String> customParams) {
        ...
        try (CloseableHttpClient client = HttpClientBuilder.create().build()) {
            String url = baseUrl + path;
            // System.err.println("getOpenhabVariable url: " + url);
