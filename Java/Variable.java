...
import org.openhab.binding.ubidots.Value.StatisticsFigures;
...
public class Variable extends ApiObject {
    ...
    public Map getObject(String name) { // IS
    ...
    private double getStatistics(String figure, long startTime, long endTime) {
        String json = bridge.get("variables/" + getId() + "/statistics/" + figure + "/" + startTime + "/" + endTime);
